...
public class PaletteAct extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mTvBody.setOnClickListener(this);
...
//                .clearFilters();
    ...
    @Override
        public void onClick(View v){
            switch (v.getId()){
                case R.id.tvBody:
                    mIvPic.setImageDrawable(getResources().getDrawable(R.mipmap.icon_loading));
                    setTextBackgroundColor();                    break;
                case R.id.tvTitle:
                    mIvPic.setImageDrawable(getResources().getDrawable(R.mipmap.bg));
                    setTextBackgroundColor();
                    break;
                default:
                    break;
