...
import com.zjf.myself.codebase.thirdparty.parallaxView.Item;
import com.zjf.myself.codebase.thirdparty.parallaxView.ItemAdapter;
import com.zjf.myself.codebase.thirdparty.parallaxView.ParallaxRecyclerView;
...
public class RecyclerViewGridActivity extends AppCompatActivity {
    ...
    private List<Item> itemList() {
        ...
        for (int i = 0; i < 28; i++) {
            if (i % 2 == 0) {
                items.add(new Item(R.mipmap.girl, "赵丽颖"));
            } else {
                items.add(new Item(R.mipmap.girl_1, "ZhaoLiying"));
            }
        }
        return items;
    }
