...
import com.zjf.myself.codebase.view.KCalendarView;
...
public class CalendarAct extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.win_calendar);
        bt = (Button) findViewById(R.id.bt);
        bt.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                new PopupWindows(CalendarAct.this, bt);
            }
    ...
    public class PopupWindows extends PopupWindow {
        ...
        public PopupWindows(Context mContext, View parent) {
            ...
            ll_popup.startAnimation(AnimationUtils.loadAnimation(mContext, R.anim.push_up_in));
            ...
            final KCalendarView calendar = (KCalendarView) view
