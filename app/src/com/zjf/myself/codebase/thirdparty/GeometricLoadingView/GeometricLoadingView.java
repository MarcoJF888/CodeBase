 ...
 */
public class GeometricLoadingView extends FrameLayout {
    ...
    public GeometricLoadingView(Context context) {
        super(context);
    }

    public GeometricLoadingView(Context context, AttributeSet attrs) {
    ...
    public GeometricLoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
