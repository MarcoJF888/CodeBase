...
public class Crop {
    ...
    public static final int REQUEST_CAMERA = 9163;
    ...
    public static void cameraImage(Activity activity) {
    	cameraImage(activity, REQUEST_CAMERA);
    }
    ...
    public static void cameraImage(Activity activity, int requestCode) {
    	Intent intent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
    	try {
    		Uri fileUri = Uri.fromFile(PicTools.getOutputPhotoFile());
