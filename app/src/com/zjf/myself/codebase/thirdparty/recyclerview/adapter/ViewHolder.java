...
public class ViewHolder extends RecyclerView.ViewHolder
{
     ...
     * @return
     */
//    public ViewHolder setImageByUrl(int viewId, String url,int def) {
//        ViewUtils.setImageByUrl(getView(viewId),url,def);
//        return this;
//    }
//
//    /**
...
//        ImageLoader.getInstance().displayImage(url, img, option);
//        return this;
//    }
     ...
     * @return
     */
//    public ViewHolder setImageByUrlHasTag(int viewId, final String url, DisplayImageOptions option)
//    {
//        ImageView img = getView(viewId);
//        img.setTag(url);
