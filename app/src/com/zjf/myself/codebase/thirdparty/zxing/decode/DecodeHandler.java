...
package com.zjf.myself.codebase.thirdparty.zxing.decode;
...
import com.zjf.myself.codebase.util.BitmapUtil;
...
public class DecodeHandler extends Handler {
	 ...
	 * 保存扫码区域图片
	 */
	static void saveFile(PlanarYUVLuminanceSource source,boolean success){
		String sus="n";
		if(success)
			sus="y";

		BitmapUtil.saveBitmapToFile(getBmp(source), TimeUtil.formatTime(TimeUtil.FORMAT_1,System.currentTimeMillis())+"_"+sus+".jpg");
	}

	static Bitmap getBmp(PlanarYUVLuminanceSource source) {
