package com.zjf.myself.codebase.thirdparty.zxing;
...
import com.zjf.myself.codebase.thirdparty.zxing.camera.CameraManager;
import com.zjf.myself.codebase.thirdparty.zxing.decode.DecodeThread;
import com.zjf.myself.codebase.thirdparty.zxing.decode.PhotoScanHandler;
import com.zjf.myself.codebase.thirdparty.zxing.decode.RGBLuminanceSource;
import com.zjf.myself.codebase.thirdparty.zxing.utils.BeepManager;
import com.zjf.myself.codebase.thirdparty.zxing.utils.BitmapUtil;
import com.zjf.myself.codebase.thirdparty.zxing.utils.CaptureActivityHandler;
import com.zjf.myself.codebase.thirdparty.zxing.utils.InactivityTimer;
...
public class ScanManager implements SurfaceHolder.Callback{
	...
	void initCrop() {
		...
		/** 生成最终的截取的矩形 */
		mCropRect = new Rect(x-50, y-120, width+ x+50, height + y-100);

//		View view=new View(scanContainer.getContext());
//		view.setBackgroundColor(0x50ff5f19);
//		RelativeLayout.LayoutParams params=new RelativeLayout.LayoutParams(scanCropView.getWidth(),scanCropView.getHeight());
//		params.setMargins(cropLeft,cropTop- DesityUtil.dp2px(scanContainer.getContext(),50),0,0);
//		view.setLayoutParams(params);
//		((RelativeLayout)scanContainer).addView(view);
	}
