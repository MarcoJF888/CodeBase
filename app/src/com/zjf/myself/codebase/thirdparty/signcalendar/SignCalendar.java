package com.zjf.myself.codebase.thirdparty.signcalendar;
...
public class SignCalendar extends ViewFlipper implements
  ...
  public static final int COLOR_BG_WEEK_TITLE = Color.parseColor("#3F51B5"); // 星期标题背景颜色
  ...
  public static final int COLOR_TX_THIS_DAY = Color.parseColor("#3F51B5"); // 当天日历数字颜色
  ...
  private void setMarker(RelativeLayout group, int i, int j) {
    ...
    if (marksMap.get(dates[i][j]) != null) {
      if (childCount < 2) {
        ...
        markView.setBackgroundResource(R.mipmap.calendar_bg_tag1);
