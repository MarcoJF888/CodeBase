...
public class SwipeMenuLayout1 extends LinearLayout {
    ...
    public SwipeMenuLayout1(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SwipeMenuLayout1(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        //获取右边菜单id
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.SwipeMenuLayout1);
        mRightId = typedArray.getResourceId(R.styleable.SwipeMenuLayout1_right_id, 0);
        typedArray.recycle();
    }
