...
public class SwipeRecycleView1 extends RecyclerView {
    private SwipeMenuLayout1 mLastMenuLayout;
    private int mLastTouchPosition;
    protected int mScaleTouchSlop;

    public SwipeRecycleView1(Context context) {
        this(context, null);
    }

    public SwipeRecycleView1(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SwipeRecycleView1(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (touchPos != mLastTouchPosition && mLastMenuLayout != null
                        && mLastMenuLayout.currentState != SwipeMenuLayout1.STATE_CLOSED) {
                    ...
                    if (holder != null) {
                        ...
                        if (childView != null && childView instanceof SwipeMenuLayout1) {
                            mLastMenuLayout = (SwipeMenuLayout1) childView;
            ...
            case MotionEvent.ACTION_CANCEL:
                ...
                if (Math.abs(dx) > mScaleTouchSlop && Math.abs(dx) > Math.abs(dy)
                        || (mLastMenuLayout != null && mLastMenuLayout.currentState != SwipeMenuLayout1.STATE_CLOSED)) {
