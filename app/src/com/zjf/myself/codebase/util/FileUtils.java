...
public class FileUtils {
	...
	public static String getImageDownloadDir(Context context) {
		...
		if (FileUtils.hasSDCard()) {
			// 有SD卡
			filePath = AppConstants.STORE_IMG_PATH;
		} else {
			// 没有SD卡
	...
	public static String getCacheDownloadDir(){
		if(FileUtils.hasSDCard()){
			return AppConstants.STORE_CACHE_PATH;
		}
		return null;
	}
	...
	public static void saveToSDCard(Bitmap bm, String url) {
		...
		String downFilePath = AppConstants.STORE_IMG_PATH;
	...
	public static void saveToMobile(Bitmap bm, String url, Context context) {
		...
		String path = context.getFilesDir().getPath();
		String filePath = path + File.separator + "yam_shop/image" + File.separator;
