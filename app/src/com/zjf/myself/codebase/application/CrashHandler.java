...
import com.zjf.myself.codebase.util.FileUtils;
...
//				ViewUtils.showToast( "很抱歉,程序出现异常,即将退出！");
	...
	public void collectDeviceInfo(Context ctx) {
		String versionName = Config.mVersionName;
		String versionCode = Config.mVersionCode + "";
	...
	private String saveCrashInfo2File(Throwable ex) {
		...
		try {
			...
			if (FileUtils.hasSDCard()) {
				String path = AppConstants.STORE_CACHE_PATH+"/error";
