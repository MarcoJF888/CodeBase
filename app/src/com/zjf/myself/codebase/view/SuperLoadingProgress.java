...
//    private ValueAnimator mForkAnimation;
    ...
    private void init(){
        ...
        tickPaint.setColor(Color.argb(255, 103, 184, 43));
...
//        });
        ...
        mTickAnimation.setStartDelay(200);
