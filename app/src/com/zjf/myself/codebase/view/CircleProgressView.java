...
//		super.onDraw(canvas);
	 ...
	 * 设置圆环进度条的宽度 px
	 */
	public CircleProgressView setProdressWidth(int width) {
	 ...
	 * @param value
	 */
	public CircleProgressView setTextSize(int value) {
		textSize = value;
		return this;
	}
	 ...
	 * @param
	 */
	public CircleProgressView setTextColor(int color) {
	 ...
	 * @param
	 */
	public CircleProgressView setPreProgress(int precolor) {
	 ...
	 * @param color
	 */
	public CircleProgressView setProgress(int color) {
	 ...
	 * @return
	 */
	public CircleProgressView setCircleBackgroud(int color) {
	 ...
	 * @param scale
	 */
	public CircleProgressView setPaddingscale(float scale) {
	 ...
	 */
	public CircleProgressView setStartAngle(int startAngle) {
